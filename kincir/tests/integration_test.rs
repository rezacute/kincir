...
mod mqtt_to_rabbitmq_tunnel_tests {
    ...
    use lapin::{options::*, types::FieldTable, Connection, ConnectionProperties, Consumer}; // Removed Channel
    use rumqttc::{AsyncClient as MqttClient, MqttOptions, QoS as MqttQoS};
    use tokio::time::{timeout, Duration}; // Replaced tokio::stream::StreamExt
